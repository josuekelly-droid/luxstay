  ...
  return (
    <main className="pt-16 sm:pt-20">
      ...
      <section className="relative min-h-[90vh] flex items-center bg-gradient-to-br from-luxury-green-dark via-luxury-green to-luxury-green-light">
        <div className="container mx-auto px-4 relative z-10 py-10 sm:py-0">
      ...
      {/* ========== BARRE DE RECHERCHE ========== */}
      <section className="py-8 sm:py-12 bg-luxury-sand-light">
        <div className="container mx-auto px-4">
          <div className="bg-white rounded-2xl shadow-luxury p-4 sm:p-6 max-w-5xl mx-auto -mt-16 sm:-mt-20 md:-mt-24 relative z-20">
      ...
      <section className="py-12 sm:py-16 md:py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-8 sm:mb-12">
            <span className="text-luxury-gold font-semibold uppercase tracking-wider text-xs sm:text-sm">
              ✦ Sélection LuxStay
            </span>
            <h2 className="font-display text-2xl sm:text-3xl md:text-4xl font-bold text-luxury-green-dark mt-2">
              Biens en vedette
            </h2>
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-luxury-sand-light">
        <div className="container mx-auto px-4">
          <h2 className="font-display text-2xl sm:text-3xl md:text-4xl font-bold text-center text-luxury-green-dark mb-8 sm:mb-12">
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-gradient-to-r from-luxury-gold to-luxury-gold-light">
        <div className="container mx-auto px-4 text-center">
          <h2 className="font-display text-2xl sm:text-3xl md:text-4xl font-bold text-luxury-green-dark mb-3 sm:mb-4">
            Vous êtes propriétaire ou agent immobilier ?
          </h2>
          <p className="text-luxury-green-dark/80 text-sm sm:text-base md:text-lg mb-6 sm:mb-8 max-w-2xl mx-auto">
