...
export default function BienDetailPage() {
  ...
  const telPropre = annonce.user.telephone?.replace(/[^0-9]/g, '') || '';
  const whatsappUrl = `https://wa.me/${telPropre}?text=${encodeURIComponent(`Bonjour, je suis intéressé par votre annonce "${annonce.titre}" sur LuxStay`)}`;
  const emailUrl = `mailto:${annonce.user.email}?subject=${encodeURIComponent(`À propos de votre annonce "${annonce.titre}"`)}&body=${encodeURIComponent('Bonjour, je suis intéressé par votre annonce sur LuxStay.')}`;
              ...
              <div className="space-y-2 sm:space-y-3">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <a
                    ...
                    className="bg-green-500 text-white w-full flex items-center justify-center gap-2 text-sm py-2.5 rounded-xl font-semibold hover:bg-green-600 transition"
                  >
                  ...
                  <a
                    href={emailUrl}
                    className="bg-blue-500 text-white w-full flex items-center justify-center gap-2 text-sm py-2.5 rounded-xl font-semibold hover:bg-blue-600 transition"
                  >
