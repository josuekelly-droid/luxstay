        ...
        <div className="bg-white rounded-2xl shadow-luxury p-6 max-w-4xl mx-auto mb-8">
          ...
          <div className="flex flex-wrap gap-3 mt-4">
            <select
              ...
              className="input-luxury text-sm w-auto"
            >
            ...
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-medium transition ${
                filtresAvances ? 'bg-luxury-green text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
              }`}
            >
                    ...
                    <div className="flex items-center gap-4 text-sm text-gray-400">
                      {annonce.chambres && (
                        <span className="flex items-center gap-1">
                          <Bed size={14} /> {annonce.chambres}
                        </span>
                      )}
                      {annonce.surface && (
                        <span className="flex items-center gap-1">
                          <Maximize size={14} /> {annonce.surface} m²
                        </span>
                      )}
                      <span className="flex items-center gap-1 ml-auto">
                        <Eye size={14} /> {annonce.vues}
                      </span>
                    </div>
                  </div>
                </Link>
            ...
            {totalPages > 1 && (
              <div className="flex items-center justify-center gap-3 mt-10">
                <button
                  ...
                  disabled={page === 1}
                  className="p-3 rounded-xl bg-white shadow-card hover:bg-gray-50 disabled:opacity-50 transition"
                >
                  <ChevronLeft size={20} />
                </button>
                      ...
                      <button
                        ...
                        className={`w-10 h-10 rounded-xl font-medium transition ${
                          page === p
                            ...
                            : 'bg-white shadow-card hover:bg-gray-50 text-gray-600'
                        }`}
                      >
                        {p}
                      </button>
